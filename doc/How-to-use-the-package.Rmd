...
An example dataset corresponding to co-IP experiment in Arabidopsis ([Scheer et de Almeida *et al.* 2020](https://doi.org/10.1101/2020.05.26.114322)) was included in the package. 
...
An interactive can be created and saved using [**DT package**](https://cran.r-project.org/web/packages/DT/index.html)  
```{r results = 'hide'}
createTable(annotated_table_At)
```

The interactive table can be saved under html format.  
```{r}
...
Results table can also be saved using [**xlsx package**](https://cran.r-project.org/web/packages/xlsx/index.html)
```{r}
